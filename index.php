  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto align-items-center">
        ...
        <li class="nav-item"><a class="nav-link" href="mahasiswa/list.php">Mahasiswa</a></li>
        <li class="nav-item"><a class="nav-link" href="program_studi/list.php">Program Studi</a></li>

        <li class="nav-item">
          <a class="btn btn-danger btn-sm ms-2" href="logout.php" onclick="return confirm('Yakin ingin logout?')">Logout</a>
        </li>
      </ul>
    </div>
  </div>
